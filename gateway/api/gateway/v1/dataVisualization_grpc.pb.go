...
type DataVisualizationClient interface {
	...
	// 设备数据推送
	DeviceDataPush(ctx context.Context, in *DeviceDataPushReq, opts ...grpc.CallOption) (*DeviceDataPushRes, error)
	//折线图，当天，七天，近一个月
...
func (c *dataVisualizationClient) DeviceDataGet(ctx context.Context, in *DeviceDataGetReq, opts ...grpc.CallOption) (*DeviceDataGetRes, error) {
	...
	err := c.cc.Invoke(ctx, "/api.gateway.v1.DataVisualization/DeviceDataGet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataVisualizationClient) DeviceDataPush(ctx context.Context, in *DeviceDataPushReq, opts ...grpc.CallOption) (*DeviceDataPushRes, error) {
	out := new(DeviceDataPushRes)
	err := c.cc.Invoke(ctx, "/api.gateway.v1.DataVisualization/DeviceDataPush", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataVisualizationClient) DeviceDataCurve(ctx context.Context, in *DeviceDataCurveReq, opts ...grpc.CallOption) (*DeviceDataCurveRes, error) {
	...
	err := c.cc.Invoke(ctx, "/api.gateway.v1.DataVisualization/DeviceDataCurve", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DataVisualizationServer interface {
	...
	// 设备数据推送
	DeviceDataPush(context.Context, *DeviceDataPushReq) (*DeviceDataPushRes, error)
	//折线图，当天，七天，近一个月
...
func (UnimplementedDataVisualizationServer) DeviceDataPush(context.Context, *DeviceDataPushReq) (*DeviceDataPushRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeviceDataPush not implemented")
}
...
func _DataVisualization_DeviceDataGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.gateway.v1.DataVisualization/DeviceDataGet",
	}
...
func _DataVisualization_DeviceDataPush_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeviceDataPushReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataVisualizationServer).DeviceDataPush(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.gateway.v1.DataVisualization/DeviceDataPush",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataVisualizationServer).DeviceDataPush(ctx, req.(*DeviceDataPushReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DataVisualization_DeviceDataCurve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.gateway.v1.DataVisualization/DeviceDataCurve",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var DataVisualization_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.gateway.v1.DataVisualization",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeviceDataPush",
			Handler:    _DataVisualization_DeviceDataPush_Handler,
		},
		{
	...
	Metadata: "api/gateway/v1/dataVisualization.proto",
}
